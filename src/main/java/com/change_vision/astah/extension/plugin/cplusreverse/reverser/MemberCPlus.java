...
//		if (type.indexOf(KEYWORD_EXPLICIT) != -1) {
//			type = type.replaceFirst(KEYWORD_EXPLICIT + " ", "");
//			keywords.add(KEYWORD_EXPLICIT);
//		}
//		if (type.indexOf(KEYWORD_INLINE) != -1) {
//			type = type.replaceFirst(KEYWORD_INLINE + " ", "");
//			keywords.add(KEYWORD_INLINE);
//		}
//		if (type.indexOf(KEYWORD_MUTABLE) != -1) {
//			type = type.replaceFirst(KEYWORD_MUTABLE + " ", "");
//			keywords.add(KEYWORD_MUTABLE);
//		}
	...
	throws ProjectNotFoundException, ClassNotFoundException, InvalidEditingException {
		...
		IOperation newOperation = Tool.getOperation(parentClass, "operation" + operaNum++, returnType);
